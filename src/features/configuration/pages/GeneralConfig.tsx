...
const ConfiguracionesGeneral = () => {
    ...
    const NUMBER_KEYS = ['MINUTOS_ALMUERZO_DEFAULT', 'HORAS_JORNADA_DIARIA', 'HORAS_LABORABLES_MES', 'HORAS_MINIMAS_REINICIO_TURNO', 'HORAS_MAXIMAS_JORNADA', 'TOLERANCIA_ATRASO'];
